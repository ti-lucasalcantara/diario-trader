            ...
            <div class="ibox-content">
                ...
                <div class="row">
                    <div class="form-group col-md-2">
                        ...
                        <input type="text" name="ticker" id="ticker" placeholder="Ativo" class="form-control">
                    ...
                    <div class="form-group col-md-2" id="date">
                        ...
                        <div class="input-group date">
                            ...
                            <input type="text" class="form-control" inputmode="date" name="date_in" value="<?=$date_in;?>">
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <input type="text" placeholder="" inputmode="numeric" name="hour_in" placeholder="hh:mm:ss" class="form-control mask_hour">
                        <div class="text-right text-danger small" id="error_hour_in"></div>
                    </div>
                    <div class="form-group col-md-2">
                        <label>Hora Saída</label>
                        <input type="text" placeholder="" inputmode="numeric" name="hour_out" placeholder="hh:mm:ss" class="form-control mask_hour">
                        <div class="text-right text-danger small" id="error_hour_out"></div>
                    </div>
                    <div class="form-group col-md-2">
                        <label>Preço Entrada</label>
                        <input type="text" placeholder="" inputmode="numeric" name="price_in" placeholder="0" class="form-control mask_currency_without_prefix">
                        <div class="text-right text-danger small" id="error_price_in"></div>
                    </div>
                    <div class="form-group col-md-2">
                        <label>Preço Saída</label>
                        <input type="text" placeholder="" inputmode="numeric" name="price_out" placeholder="0" class="form-control mask_currency_without_prefix">
                ...
                <div class="row">
                    <div class="form-group col-md-8">
                        ...
                        <input type="text" name="setup" id="setup" placeholder="Estratégia" class="form-control">
                        <div class="text-right text-danger small" id="error_setup"></div>
                    </div>
                    <div class="form-group col-md-2">
                        <label>Operação</label>
                        <div class="radio radio-success">
                            <input type="radio" id="Compra" inputmode="numeric" value="Compra" name="command" checked="">
                            <label for="Compra"> Compra</label>
                        </div>
                        <div class="radio radio-danger">
                            <input type="radio" id="Venda" inputmode="numeric" value="Venda" name="command">
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <input type="text" placeholder="0" value="01" name="number_of_papers" class="form-control touchspin">
